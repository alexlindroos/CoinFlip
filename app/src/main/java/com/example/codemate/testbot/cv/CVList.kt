...
class CVList: BaseActivity(), AppCompatCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val pic = BitmapFactory.decodeResource(applicationContext.resources, R.drawable.face)
        //val pic2 = BitmapFactory.decodeResource(applicationContext.resources, R.drawable.face2)
        //val pic3 = BitmapFactory.decodeResource(applicationContext.resources, R.drawable.face3)
        //val pic4 = BitmapFactory.decodeResource(applicationContext.resources, R.drawable.face4)
